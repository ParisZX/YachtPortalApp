...
class YachtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create yacht" do
    assert_difference('Yacht.count') do
      post yachts_url, params: { yacht: { name: @yacht.name, size: @yacht.size, type: @yacht.type } }
    end
  ...
  test "should update yacht" do
    patch yacht_url(@yacht), params: { yacht: { name: @yacht.name, size: @yacht.size, type: @yacht.type } }
